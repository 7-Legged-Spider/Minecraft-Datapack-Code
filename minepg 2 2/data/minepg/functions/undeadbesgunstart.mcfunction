...
execute as @a at @s[scores={besability=1..}, nbt={Inventory:[{id:"minecraft:stone_button", Count:1b, tag:{bedrockemissary:1b}}], SelectedItem:{tag:{bf:4b}}}] at @s positioned ~ ~1.5 ~ positioned ^ ^ ^0.51 if block ~ ~2 ~ air run function minepg:undeadbesgun
